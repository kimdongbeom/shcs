...
//                                    }
    ...
    private static void makeReultData(String materialId, String[] lines, List<Material> materialList) {
        ...
        for (Material material : materialList) {
            ...
            resultDataList.add(convertReulstDataList(material, targetData));
            /**
             * todo
    ...
    private static ResultExcel convertReulstDataList(Material material, List<String> targetData) {
