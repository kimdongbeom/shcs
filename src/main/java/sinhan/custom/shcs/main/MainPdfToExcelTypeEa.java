...
import sinhan.custom.shcs.Service.ExcelServiceEA;
...
//                if (line.contains("Amount of C")) {
            ...
            ExcelServiceEA excelService = new ExcelServiceEA();
            excelService.excelWrite(dataList, "/Users/nhnent/Desktop/shcs/S8R0013549_result333.xls");
        } catch(Exception e) {
